...
const SectionCTA = () => {
  return (
    <section>
      <div className="flex flex-col gap-5 bg-white rounded-lg mb-20 px-5 py-7 md:flex-row md:items-center md:justify-between md:px-10 md:py-12 md:border-radius">
